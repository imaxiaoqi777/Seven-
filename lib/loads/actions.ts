  ...
  if (id) {
    ...
    await createOperationLog({
      ...
      summary: buildChangeSummary([
        ...
        { label: "卸货箱号", before: beforeLoad?.blNumber, after: updated.blNumber },
        { label: "装货地址", before: beforeLoad?.vesselVoyage, after: updated.vesselVoyage },
        { label: "装货箱号", before: beforeLoad?.containerNumber, after: updated.containerNumber },
  ...
  if (createdLoadForLog) {
    await createOperationLog({
      ...
      summary: buildSnapshotSummary([
        ...
        { label: "卸货箱号", value: createdLoadForLog.blNumber },
        { label: "装货箱号", value: createdLoadForLog.containerNumber },
...
export async function deleteLoad(id: string, returnPath: string) {
  ...
  await createOperationLog({
    ...
    summary: buildSnapshotSummary([
      ...
      { label: "卸货箱号", value: targetLoad.blNumber },
      { label: "装货地址", value: targetLoad.vesselVoyage },
      { label: "装货箱号", value: targetLoad.containerNumber },
